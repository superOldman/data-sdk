import {
  isObject, isFunction, isEmptyObject, isString, isArray, each, trim, _decodeURI,
  getURL, getURLPath, getCookieTopLevelDomain, UUID, extend, _URL, strip_empty_properties
} from '@/utils/index'
import { source_channel_standard, sdkversion_placeholder, domain_test_key } from '@/constant'
import { getQueryParam, getHostname, getQueryParamsFromUrl, getEleInfo, getElementContent$1 } from "@/utils/tools";
import { cookie$1, getCurrentDomain } from '@/Storage/cookie.js'
...
import { logger, sdLog, debug } from '@/utils/debugger'
...
export function isReferralTraffic(refererstring) {
...
export function getReferrer(referrer, full) {
...
export function getKeywordFromReferrer(referrerUrl, activeValue) {
