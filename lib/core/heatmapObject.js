...
import { getEleInfo, isElement } from '@/utils/tools'
import { isFunction, isArray, isObject, getURL, getURLPath, isNumber, indexOf, each, extend, hasAttributes } from "@/utils/index";
