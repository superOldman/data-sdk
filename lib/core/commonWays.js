import { isObject, isFunction,isEmptyObject, each,isString,isArray, getURLPath, 
  isJSONString,getURL, extend, hasAttributes } from '@/utils/index'
import { _localStorage, _sessionStorage } from '@/Storage/storage'
import { getKeywordFromReferrer,isReferralTraffic,getReferrer,getSourceFromReferrer } from '@/core/commonFn'
